 ...
 */
class GitQuickError extends Error {
 ...
 */
class ValidationError extends GitQuickError {
	constructor(message, suggestion = '') {
 ...
 */
class GitRepositoryError extends GitQuickError {
 ...
 */
class GitNotFoundError extends GitQuickError {
 ...
 */
class GitCommandError extends GitQuickError {
